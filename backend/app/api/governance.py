...
<title>ReleaseOps Compliance Certificate — {cert_id[:8]}</title>
<style>
...
<div class="cert">
  <div class="cert-header">
    <h1>🛡 ReleaseOps Compliance Certificate</h1>
  ...
  <div class="cert-footer">
    This certificate was generated by ReleaseOps AI Release Governance Platform.<br/>
